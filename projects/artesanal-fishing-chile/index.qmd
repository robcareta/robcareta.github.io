...
Explore the fishing activity data interactively — spatial map, distance gradient from farms, and fleet trends — in the **[VMS Fishing Explorer](vms-explorer.qmd)**.
:::
